...
class MyGPControllerTest {
    ...
    public void updateJoinStatus() throws Exception {
        ...
        Mockito.doNothing().when(joinSvc).updateStatus(new Join(), status);
        ...
        Mockito.verify(joinSvc, Mockito.times(1)).updateStatus(new Join(), status);
    ...
    public void updateAllJoinStatus() throws Exception {
        ...
        Mockito.doNothing().when(joinSvc).updateAllStatus(new LinkedList<Join>(), 2);
        ...
        Mockito.verify(joinSvc, Mockito.times(1)).updateAllStatus(new LinkedList<Join>(), status);
