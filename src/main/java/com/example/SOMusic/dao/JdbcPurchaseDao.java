...
public class JdbcPurchaseDao implements PurchaseDao {
	...
	private static final String INSERT_SQL = 
			...
			+ "VALUE (squence_purchase.nextval, :consumer_id, :consumer_name, :total_amount, :address, :zipcode, :phone, :shipping_method, :shipping_request, :product_id)";
	@Override
